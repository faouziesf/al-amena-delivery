...
<div x-show="activeMode === 'manual'" class="space-y-4">
    ...
    <div>
        ...
        <!-- Code Info -->
        <div x-show="manualCode.trim().length > 0" class="mt-1 text-sm text-blue-600">
            Prêt à rechercher : <span x-text="manualCode.trim()"></span>
        </div>
    </div>
        ...
        <div class="flex items-start space-x-2">
            ...
            <div>
                ...
                <ul class="text-xs text-blue-700 mt-1 space-y-1">
                    <li>• Format principal: PKG_HNIZCWH4_20250921</li>
                    <li>• Format court: PKG_000038, PKG_000007</li>
                    <li>• URL complète: http://127.0.0.1:8000/track/PKG_HNIZCWH4_20250921</li>
                    <li>• Codes alphanumériques (6-20 caractères)</li>
                    <li>• Codes numériques (6-20 chiffres)</li>
                </ul>
            </div>
        </div>
    </div>
...
window.codeInputHelpers = {
    getCodeSuggestions(partialCode) {
        ...
        if (upper.startsWith('PKG') && !upper.includes('_')) {
            // Format principal: PKG_XXXXXXXX_YYYYMMDD
