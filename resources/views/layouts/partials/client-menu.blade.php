...
<div class="space-y-1">
    ...
    <a href="{{ route('client.pickup-requests.index') }}" 
       class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-smooth"
       :class="currentRoute.includes('pickup') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50'">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('client.complaints.index') }}" 
       class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-smooth"
       :class="currentRoute.includes('complaints') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50'">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
