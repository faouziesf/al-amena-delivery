    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-64 bg-white shadow-xl border-r border-orange-200 flex flex-col">
            ...
            <nav class="p-4 space-y-2 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-orange-300 scrollbar-track-orange-100">
                ...
                <!-- Fonctions Commerciales (déroulant) -->
                <div x-data="{ open: false }" class="pt-4 border-t border-gray-200">
                    <button @click="open = !open"
                            class="nav-item w-full flex items-center justify-between px-4 py-3 rounded-lg transition-all duration-200 group text-gray-700 hover:bg-orange-50 hover:text-orange-600">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="open" x-transition class="ml-8 mt-2 space-y-1">
                        <a href="{{ route('depot-manager.commercial.topup-requests.index') }}" class="block px-4 py-2 text-sm text-gray-600 hover:text-orange-600 hover:bg-orange-50 rounded">Demandes recharge</a>
                        <a href="{{ route('depot-manager.commercial.withdrawals.index') }}" class="block px-4 py-2 text-sm text-gray-600 hover:text-orange-600 hover:bg-orange-50 rounded">Demandes paiement</a>
                        <a href="{{ route('depot-manager.commercial.tickets.index') }}" class="block px-4 py-2 text-sm text-gray-600 hover:text-orange-600 hover:bg-orange-50 rounded">Tickets support</a>
                    </div>
                </div>
                ...
                <a href="{{ route('depot-manager.reports.index') }}"
                   class="nav-item flex items-center px-4 py-3 rounded-lg transition-all duration-200 group {{ request()->routeIs('depot-manager.reports.*') ? 'bg-orange-100 text-orange-700 shadow-sm' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}">
                    <svg class="w-5 h-5 mr-3 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm border-b border-orange-200 px-4 lg:px-6 py-4 flex-shrink-0">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:flex items-center space-x-4 text-sm">
                            <div class="flex items-center space-x-2 text-orange-600">
                                ...
                                <span x-text="stats.total_deliverers + ' livreurs'"></span>
                            </div>
                            <div class="flex items-center space-x-2 text-blue-600">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                </svg>
                                <span x-text="stats.delivered_today + ' livrés aujourd\'hui'"></span>
                            </div>
                            <div class="flex items-center space-x-2 text-green-600">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"/>
                                </svg>
                                <span x-text="formatAmount(stats.cod_collected_today) + ' DT collecté'"></span>
                            </div>
                        </div>

                        <!-- Actions rapides dans le header -->
                        <div class="hidden lg:flex items-center space-x-2">
                            <a href="{{ route('depot-manager.packages.dashboard-actions') }}"
                               class="inline-flex items-center px-3 py-2 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors text-sm font-medium"
                               title="Actions requises pour échanges et retours">
                            ...
                            <a href="{{ route('depot-manager.crates.box-manager') }}"
                               ...
                               title="Gestionnaire de boîtes de transit">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                </svg>
                                Boîtes Transit
                ...
                <!-- Actions rapides mobile (dropdown) -->
                <div x-show="showMobileActions"
                     ...
                     class="lg:hidden mt-4 grid grid-cols-1 gap-2">
                    <a href="{{ route('depot-manager.packages.dashboard-actions') }}"
                       class="flex items-center px-3 py-2 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors text-sm font-medium">
