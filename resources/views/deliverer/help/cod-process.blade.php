...
@section('content')
<div x-data="codProcessGuide" class="max-w-4xl mx-auto p-4 space-y-6">
    <!-- Header -->
    <div class="bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-xl p-6">
        <div class="flex items-center space-x-4">
            <a href="{{ route('deliverer.help.index') }}" class="text-yellow-100 hover:text-white">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold mb-2">Guide Processus COD</h1>
                <p class="text-yellow-100">Maîtrisez la gestion des paiements à la livraison</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="text-center p-4 bg-green-50 rounded-lg">
                ...
                <h3 class="font-semibold text-gray-900">Collecte</h3>
                <p class="text-sm text-gray-600">Encaissement du montant exact</p>
            </div>
            <div class="text-center p-4 bg-blue-50 rounded-lg">
                ...
                <p class="text-sm text-gray-600">Validation dans l'application</p>
            </div>
            <div class="text-center p-4 bg-purple-50 rounded-lg">
                <div class="bg-purple-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                    <i class="fas fa-receipt text-purple-600"></i>
                </div>
                <h3 class="font-semibold text-gray-900">Reçu</h3>
                <p class="text-sm text-gray-600">Génération automatique du reçu</p>
            </div>
        </div>
    </div>
        ...
        <template x-for="(step, index) in codSteps" :key="index">
            <div class="bg-white rounded-xl shadow-sm border">
                <button @click="toggleStep(index)"
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="bg-gradient-to-r from-orange-500 to-yellow-500 text-white w-10 h-10 rounded-full flex items-center justify-center font-bold"
                             x-text="index + 1"></div>
                        <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <template x-if="step.hasAction">
                            <div class="mt-4 flex space-x-3">
                                <button @click="simulateStep(step.actionType)"
            ...
            <template x-for="rule in importantRules" :key="rule.id">
                <div class="bg-white rounded-lg p-4 border-l-4 border-red-400">
                    <div class="flex items-start space-x-3">
                        <i :class="rule.icon + ' text-red-600 mt-1'"></i>
                        <div>
                            <h3 class="font-semibold text-gray-900 mb-2" x-text="rule.title"></h3>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <p class="text-gray-600 mb-4">Vérifiez rapidement les montants à collecter</p>

        <div class="bg-gray-50 rounded-lg p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Montant du colis (DA)</label>
                    <input type="number"
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Frais de livraison (DA)</label>
                    <input type="number"
            ...
            <div class="bg-white rounded-lg p-4 border-2 border-green-200">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-lg font-semibold text-gray-900">Montant total à collecter :</span>
                    <span class="text-2xl font-bold text-green-600" x-text="calculator.total + ' DA'"></span>
                </div>
                <div class="text-sm text-gray-600">
                    <div class="flex justify-between">
                        <span>Colis : <span x-text="calculator.packageAmount"></span> DA</span>
                        <span>Livraison : <span x-text="calculator.deliveryFee"></span> DA</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <template x-for="faq in codFaqs" :key="faq.id">
                <div class="border rounded-lg">
                    <button @click="toggleFaq(faq.id)"
                            class="w-full p-4 text-left flex items-center justify-between hover:bg-gray-50 rounded-lg">
                    ...
                    <div x-show="openFaqs.includes(faq.id)"
                         ...
                         class="px-4 pb-4">
                        <p class="text-gray-600 text-sm" x-text="faq.answer"></p>
                    </div>
                </div>
            </template>
        </div>
    ...
    <!-- Emergency Contact -->
    <div class="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl border border-orange-200 p-6">
        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center">
            <i class="fas fa-phone text-red-600 mr-3"></i>
            En cas de problème
        </h2>
        <p class="text-gray-600 mb-4">Si vous rencontrez des difficultés avec un paiement COD :</p>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="tel:+213123456789"
               class="flex items-center space-x-3 bg-white p-4 rounded-lg border hover:shadow-md transition-shadow">
                <div class="bg-red-100 p-2 rounded-lg">
                    <i class="fas fa-phone text-red-600"></i>
                </div>
                <div>
                    <p class="font-semibold text-gray-900">Urgence COD</p>
            ...
            <button @click="reportIssue"
                ...
                <div>
                    <p class="font-semibold text-gray-900">Signaler un problème</p>
                    <p class="text-sm text-gray-600">Via l'application</p>
                </div>
            </button>
        </div>
    </div>
    ...
    Alpine.data('codProcessGuide', () => ({
        ...
        codSteps: [
            {
                ...
                content: `
                    <div class="space-y-3">
                        <p><strong>Avant de partir en livraison :</strong></p>
            ...
            },
            {
                ...
                content: `
                    <div class="space-y-3">
                        <p><strong>Processus de collecte :</strong></p>
                        <ol class="list-decimal list-inside space-y-1 text-sm ml-4">
                            <li>Vérifiez les billets reçus (authenticité)</li>
                            <li>Comptez le montant exacte</li>
            ...
            },
            {
                ...
                content: `
                    <div class="space-y-3">
                        ...
                        <p><strong>Le système va automatiquement :</strong></p>
                        <ul class="list-disc list-inside space-y-1 text-sm ml-4">
        ...
        importantRules: [
            ...
            },
            {
                ...
                description: 'N\'utilisez jamais votre argent personnel pour compléter un paiement COD insuffisant.',
                icon: 'fas fa-ban'
            }
        ],
