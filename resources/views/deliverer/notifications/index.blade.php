    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                ...
                @if($stats['unread'] > 0)
                <form method="POST" action="{{ route('deliverer.notifications.mark.all.read') }}">
                    @csrf
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow {{ !$notification->read_at ? 'border-l-4 border-purple-500' : '' }}">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex space-x-2 ml-4">
                        @if(!$notification->read_at)
                        <form method="POST" action="{{ route('deliverer.notifications.mark.read', $notification) }}">
                            @csrf
                        ...
                        <form method="POST" action="{{ route('deliverer.notifications.delete', $notification) }}">
                            @csrf
                            @method('DELETE')
