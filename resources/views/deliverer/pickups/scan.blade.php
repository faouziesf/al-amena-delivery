...
@section('page-title', 'Scanner une Collecte')
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8" x-data="scannerApp()">
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center">
            <a href="{{ route('deliverer.pickups.index') }}" class="mr-4 p-2 rounded-lg hover:bg-gray-100 transition-colors duration-200">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 mb-8">
        ...
        <!-- Success Message -->
        <div x-show="scanned" x-transition class="text-center py-8">
            <div class="success-animation w-16 h-16 bg-gradient-to-br from-green-100 to-green-200 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
            </div>
            <h3 class="text-lg font-medium text-gray-900 mb-2">QR Code scanné avec succès !</h3>
            ...
            <form @submit.prevent="manualScan()" class="space-y-4">
                <div>
                    ...
                    <input type="text"
                           ...
                           placeholder="ID de la demande de collecte ou du colis">
                </div>
                <button type="submit"
                        :disabled="!manualCode"
                        :class="manualCode ? 'bg-purple-300 hover:bg-purple-400 text-purple-800' : 'bg-gray-400 cursor-not-allowed text-white'"
    ...
    return {
        ...
        async processScan(code) {
            ...
            try {
                ...
                if (data.success) {
                    this.showSuccess('Collecte trouvée !');
                    setTimeout(() => {
