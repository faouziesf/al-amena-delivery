...
@section('page-description', 'Gestion des demandes de recharge de vos clients')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-orange-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Demandes de recharge de vos clients ({{ $topupRequests->total() }})</h3>
        </div>
                        ...
                        @foreach($topupRequests as $request)
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center">
                                            <span class="text-orange-800 font-bold text-sm">{{ strtoupper(substr($request->client->name, 0, 2)) }}</span>
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('depot-manager.commercial.topup-requests.show', $request) }}"
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Aucune demande de recharge de vos clients ne correspond à vos critères.</p>
            </div>
        @endif
    </div>
