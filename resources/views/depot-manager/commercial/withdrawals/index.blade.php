...
<div x-data="withdrawalsApp()" x-init="init()">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-purple-100 mb-6">
        ...
        <!-- Advanced Filters -->
        <div class="p-6">
            <form method="GET" action="{{ route('depot-manager.commercial.withdrawals.index') }}" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div class="flex items-end space-x-2">
                        ...
                        <a href="{{ route('depot-manager.commercial.withdrawals.index') }}"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    @if($withdrawal->status === 'APPROVED' && $withdrawal->method === 'CASH_DELIVERY')
                                        ...
                                        <!-- Generate Receipt -->
                                        <a href="{{ route('depot-manager.commercial.withdrawals.receipt', $withdrawal) }}" target="_blank"
                                    ...
                                    <!-- View Details -->
                                    <a href="{{ route('depot-manager.commercial.withdrawals.show', $withdrawal) }}"
                                       class="text-purple-600 hover:text-purple-900 p-1 rounded hover:bg-purple-100 transition-colors"
                                       title="Voir détails">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function showPendingOnly() {
    window.location.href = '{{ route("depot-manager.commercial.withdrawals.index") }}?status=PENDING';
}
