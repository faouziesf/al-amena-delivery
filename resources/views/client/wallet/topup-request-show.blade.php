                ...
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 sm:gap-3 sm:gap-2 sm:gap-3">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="space-y-2 sm:space-y-3">
                            ...
                            <div class="flex items-center justify-between py-3 flex-col sm:flex-row">
                    ...
                    <div class="space-y-3 sm:space-y-2 sm:space-y-3">
                        ...
                        <div class="flex items-start flex-col sm:flex-row">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm sm:text-xs text-gray-400">{{ $topupRequest->created_at->diffForHumans() }}</p>
                            </div>
                        </div>
                        ...
                        @if($topupRequest->processed_at)
                            ...
                            <div class="flex items-start flex-col sm:flex-row">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm sm:text-xs text-gray-400">{{ $topupRequest->processed_at->diffForHumans() }}</p>
                                    @if($topupRequest->processedBy)
                                        <p class="text-sm sm:text-xs text-gray-400">par {{ $topupRequest->processedBy->name }}</p>
                                    @endif
                                </div>
                            </div>
                        @else
