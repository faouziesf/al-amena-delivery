...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
            ...
            <!-- Badge de statut -->
            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold {{ $transaction->status_color }} shadow-sm">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between space-x-4">
                                ...
                                <div class="flex flex-col items-center">
                                    <div class="bg-gradient-to-r from-purple-100 to-pink-100 rounded-full p-3 shadow-sm mb-2">
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                <div class="space-y-3">
                                    @foreach($transaction->metadata as $key => $value)
                                        <div class="flex justify-between items-start border-b border-gray-200 pb-2 last:border-b-0 last:pb-0">
                                            ...
                                            <span class="text-sm text-gray-900 text-right min-w-0">
                                                @if(is_array($value))
                                                    <details class="cursor-pointer">
                                                        ...
                                                        <pre class="mt-2 text-xs bg-white p-2 rounded border overflow-x-auto">{{ json_encode($value, JSON_PRETTY_PRINT) }}</pre>
                                                    </details>
                                                @else
                                                    <span class="font-mono text-xs bg-white px-2 py-1 rounded border">{{ $value }}</span>
                                                @endif
                                            </span>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 border border-gray-200 hover:border-blue-300">
                                        ...
                                        <div class="text-right flex items-center gap-3">
                                            <div>
                                                ...
                                                <span class="text-xs px-2 py-1 rounded-full {{ $related->status_color }}">
                        ...
                        @if($transaction->checksum)
                            <div>
                                ...
                                <div class="flex items-center justify-between bg-gray-50 px-3 py-2 rounded-lg">
                                    <span class="font-mono text-xs text-gray-900">{{ Str::limit($transaction->checksum, 20) }}...</span>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-purple-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        @if($transaction->package_id && Route::has('client.packages.show'))
                            <a href="{{ route('client.packages.show', $transaction->package_id) }}" 
                               class="block w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-4 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-800 transition-all duration-300 text-sm font-medium text-center transform hover:scale-105 shadow-lg">
                        ...
                        <a href="{{ route('client.wallet.index') }}" 
                           class="block w-full bg-gradient-to-r from-emerald-500 to-green-600 text-white px-4 py-3 rounded-xl hover:from-emerald-600 hover:to-green-700 transition-all duration-300 text-sm font-medium text-center transform hover:scale-105 shadow-lg">
                            <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-2xl p-6">
                    ...
                    <div class="mt-4">
                        <button onclick="copyTransactionInfo()" 
                                class="w-full bg-amber-200 text-amber-800 px-4 py-2 rounded-lg hover:bg-amber-300 transition-colors text-sm font-medium">
