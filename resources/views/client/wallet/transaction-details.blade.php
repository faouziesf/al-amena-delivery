...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 -mx-4 -my-4 lg:-mx-6 lg:-my-6 px-4 py-2 sm:py-3 lg:px-4 lg:py-3 sm:py-2 sm:py-3">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 sm:mb-2 sm:mb-3 flex-col sm:flex-row">
            <div class="flex items-center mb-2 sm:mb-3 sm:mb-0 flex-col sm:flex-row">
            ...
            <!-- Badge de statut -->
            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold {{ $transaction->status_color }} shadow-md hover:shadow-md flex-col sm:flex-row">
        ...
        <div class="mb-2 sm:mb-3 sm:mb-3 sm:mb-2 sm:mb-3">
            <h1 class="text-xl sm:text-lg sm:text-xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-3">
                📊 Transaction
            </h1>
            <div class="flex flex-col sm:flex-row sm:items-center gap-3 flex-col sm:flex-row">
                <div class="font-mono text-lg text-gray-700 bg-gray-100 px-4 py-2 rounded-lg">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 sm:gap-3 sm:gap-2 sm:gap-3">
            <!-- Colonne principale -->
            <div class="xl:col-span-2 space-y-2 sm:space-y-3 sm:space-y-3 sm:space-y-2 sm:space-y-3">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-purple-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 px-4 sm:px-5 lg:px-4 py-2 sm:py-3 border-b border-purple-100">
                    ...
                    <div class="p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3">
                        <!-- Montant principal avec icône -->
                        <div class="flex items-center justify-center mb-2 sm:mb-3 sm:mb-3 sm:mb-2 sm:mb-3 flex-col sm:flex-row">
                            <div class="text-center">
                                <div class="flex items-center justify-center mb-2 sm:mb-3 flex-col sm:flex-row">
                                    @if($transaction->amount > 0)
                                        <div class="w-16 h-16 bg-gradient-to-r from-purple-100 to-purple-200 rounded-full flex items-center justify-center shadow-sm flex-col sm:flex-row">
                                            <svg class="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"/>
                                            </svg>
                                        </div>
                                    @else
                                        <div class="w-16 h-16 bg-gradient-to-r from-purple-200 to-purple-300 rounded-full flex items-center justify-center shadow-sm flex-col sm:flex-row">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-2 sm:gap-3 lg:gap-2 sm:gap-3 lg:gap-3 sm:gap-2 sm:gap-3">
                            <div class="space-y-2 sm:space-y-3">
                                <div>
                                    ...
                                    <div class="flex items-center justify-between bg-gray-50 p-3 rounded-lg flex-col sm:flex-row">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-2.5 sm:p-3">
                ...
                @if($transaction->wallet_balance_before !== null && $transaction->wallet_balance_after !== null)
                    <div class="bg-white rounded-lg shadow-sm border border-purple-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                        <div class="bg-gradient-to-r from-purple-50 to-purple-100 px-4 sm:px-5 lg:px-4 py-2 sm:py-3 border-b border-purple-200">
                            <h3 class="text-xl font-semibold text-gray-800 flex items-center flex-col sm:flex-row">
                                <svg class="w-5 h-5 mr-3 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3">
                            ...
                            <div class="flex items-center justify-between space-x-4 flex-col sm:flex-row">
                                ...
                                <div class="text-center flex-1 flex-col sm:flex-row">
                                    <div class="bg-gradient-to-r from-purple-100 to-purple-200 rounded-lg p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3 shadow-md hover:shadow-md">
                                        <p class="text-sm font-medium text-purple-700 mb-2">Solde avant</p>
                                        <p class="text-lg sm:text-xl font-bold text-purple-900">{{ number_format($transaction->wallet_balance_before, 3) }} DT</p>
                                    </div>
                                </div>
                                
                                <!-- Flèche et variation -->
                                <div class="flex flex-col items-center flex-col sm:flex-row">
                                    <div class="bg-gradient-to-r from-purple-100 to-pink-100 rounded-full p-3 shadow-md hover:shadow-md mb-2">
                                        <svg class="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Solde après -->
                                <div class="text-center flex-1 flex-col sm:flex-row">
                                    <div class="bg-gradient-to-r from-purple-200 to-purple-300 rounded-lg p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3 shadow-md hover:shadow-md">
                                        <p class="text-sm font-medium text-purple-800 mb-2">Solde après</p>
                                        <p class="text-lg sm:text-xl font-bold text-purple-900">{{ number_format($transaction->wallet_balance_after, 3) }} DT</p>
                                    </div>
                                </div>
                            </div>
                ...
                @if($transaction->package_id && $transaction->package)
                    <div class="bg-white rounded-lg shadow-sm border border-purple-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3 flex-col sm:flex-row">
                                ...
                                <div>
                                    @if(Route::has('client.packages.show'))
                                        <a href="{{ route('client.packages.show', $transaction->package_id) }}"
                                           class="inline-flex items-center px-4 sm:px-5 lg:px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-500 to-purple-700 text-white rounded-lg hover:from-purple-600 hover:to-purple-800 transition-all duration-300 transform hover:scale-105 shadow-sm transform hover:scale-105 active:scale-95 transition-all duration-200 flex-col sm:flex-row">
                                            <svg class="w-5 h-5 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                            </svg>
                                            Voir le colis
                ...
                @if($transaction->metadata && is_array($transaction->metadata) && count($transaction->metadata) > 0)
                    <div class="bg-white rounded-lg shadow-sm border border-purple-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                        <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-4 sm:px-5 lg:px-4 py-2 sm:py-3 border-b border-gray-100">
                            <h3 class="text-xl font-semibold text-gray-800 flex items-center flex-col sm:flex-row">
                        ...
                        <div class="p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3">
                            <div class="bg-gray-50 rounded-lg p-2.5 sm:p-3 border border-gray-200">
                                <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-2 sm:gap-3">@foreach($transaction->metadata as $key => $value)
                ...
                @if($relatedTransactions->count() > 0)
                    <div class="bg-white rounded-lg shadow-sm border border-purple-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3">
                            <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-2 sm:gap-3">@foreach($relatedTransactions as $related)
                                    <div class="flex items-center justify-between p-2.5 sm:p-3 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg hover:from-purple-100 hover:to-purple-200 transition-all duration-300 border border-purple-200 hover:border-purple-300 flex-col sm:flex-row">
                                        <div class="flex items-center flex-col sm:flex-row">
                                            <div class="w-5 h-5 {{ $related->amount >= 0 ? 'bg-purple-100 text-purple-600' : 'bg-purple-200 text-purple-700' }} rounded-full flex items-center justify-center mr-3 shadow-md hover:shadow-md flex-col sm:flex-row">
            ...
            <div class="space-y-3 sm:space-y-2 sm:space-y-3">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-purple-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 px-4 sm:px-5 lg:px-4 py-2 sm:py-3 border-b border-purple-100">
                        <h3 class="text-lg font-semibold text-gray-800 flex items-center flex-col sm:flex-row">
                            <svg class="w-5 h-5 sm:w-5 sm:h-5 mr-2 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            Détails techniques
                        </h3>
                    ...
                    <div class="p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3 space-y-2 sm:space-y-3">
                        @if($transaction->sequence_number)
                            <div>
                                <p class="text-sm font-medium text-gray-600 mb-1">Numéro de séquence</p>
                                <p class="font-mono text-sm bg-gray-50 px-3 py-2 rounded-lg">{{ $transaction->sequence_number }}</p>
                            </div>
                        @endif
                        ...
                        @if($transaction->checksum)
                            <div>
                                ...
                                <div class="flex items-center justify-between bg-gray-50 px-3 py-2 rounded-lg flex-col sm:flex-row">
                        ...
                        @if($transaction->reference)
                            <div>
                                ...
                                <p class="font-mono text-sm bg-gray-50 px-3 py-2 rounded-lg">{{ $transaction->reference }}</p>
                            </div>
                        @endif
                        ...
                        <div>
                            ...
                            @if($transaction->checksum && $transaction->verifyChecksum())
                                <div class="flex items-center text-green-600 bg-green-50 px-3 py-2 rounded-lg flex-col sm:flex-row">
                            ...
                            @else
                                <div class="flex items-center text-gray-500 bg-gray-50 px-3 py-2 rounded-lg flex-col sm:flex-row">
                                    <svg class="w-5 h-5 sm:w-4 sm:h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Actions rapides -->
                <div class="bg-white rounded-lg shadow-sm border border-purple-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-4 sm:px-5 lg:px-4 py-2 sm:py-3 border-b border-blue-100">
                        <h3 class="text-lg font-semibold text-gray-800 flex items-center flex-col sm:flex-row">
                            <svg class="w-5 h-5 sm:w-5 sm:h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3 space-y-3">
                        @if($transaction->package_id && Route::has('client.packages.show'))
                            <a href="{{ route('client.packages.show', $transaction->package_id) }}" 
                               class="block w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-4 py-3 rounded-lg hover:from-blue-700 hover:to-indigo-800 transition-all duration-300 text-sm font-medium text-center transform hover:scale-105 shadow-sm">
                        ...
                        <a href="{{ route('client.wallet.transactions') }}" 
                           class="block w-full bg-gray-100 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-200 transition-all duration-300 text-sm font-medium text-center transform hover:scale-105">
                            <svg class="w-5 h-5 sm:w-4 sm:h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('client.wallet.index') }}" 
                           class="block w-full bg-gradient-to-r from-emerald-500 to-green-600 text-white px-4 py-3 rounded-lg hover:from-emerald-600 hover:to-green-700 transition-all duration-300 text-sm font-medium text-center transform hover:scale-105 shadow-sm">
                            <svg class="w-5 h-5 sm:w-4 sm:h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Support et aide -->
                <div class="bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-lg p-2.5 sm:p-3 sm:p-5 lg:p-3 sm:p-2.5 sm:p-3">
                    ...
                    <div class="mt-4">
                        <button onclick="copyTransactionInfo()" 
                                class="w-full bg-amber-200 text-amber-800 px-4 sm:px-5 py-2.5 sm:py-3 rounded-lg hover:bg-amber-300 transition-colors text-sm font-medium">
...
function showToast(message, type = 'success') {
    ...
    toast.className = `fixed top-4 right-4 ${bgColor} text-white px-4 sm:px-5 lg:px-3 sm:px-4 py-2 rounded-lg shadow-sm z-50 transform transition-all duration-300`;
