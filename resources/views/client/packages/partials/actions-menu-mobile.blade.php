    ...
    <div x-show="open" @click.away="open = false"
        ...
        <div class="py-1">
            <a href="{{ route('client.packages.show', $package) }}"
               class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 active:bg-blue-100">
            ...
            <a href="{{ route('public.track.package', $package->package_code) }}" target="_blank"
               class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-green-50 active:bg-green-100">
                <svg class="mr-3 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('client.packages.print', $package) }}" target="_blank"
               class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-purple-50 active:bg-purple-100">
                <svg class="mr-3 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if($package->canBeDeleted())
                ...
                <form action="{{ route('client.packages.destroy', $package) }}" method="POST">
                    ...
                    <button type="submit"
                            ...
                            class="flex items-center w-full px-4 py-3 text-sm text-red-700 hover:bg-red-50 active:bg-red-100">
            ...
            @if(!in_array($package->status, ['PAID', 'DELIVERED_PAID']))
                ...
                <a href="{{ route('client.complaints.create', $package) }}"
                   class="flex items-center px-4 py-3 text-sm text-amber-700 hover:bg-amber-50 active:bg-amber-100">
