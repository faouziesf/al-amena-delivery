    ...
    <div class="mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div class="mb-4 lg:mb-0">
                <h1 class="text-3xl font-bold text-gray-900">➕ Ajouter un Compte Bancaire</h1>
                <p class="text-gray-600 mt-2">Ajoutez un nouveau compte pour vos retraits</p>
            </div>
            <a href="{{ route('client.bank-accounts.index') }}"
               class="inline-flex items-center px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-xl transition-all">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100">
        <form action="{{ route('client.bank-accounts.store') }}" method="POST" class="p-6">
            ...
            <div class="flex justify-end space-x-3 mt-8 pt-6 border-t">
                ...
                <button type="submit"
                        class="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg">
                    Ajouter le compte
                </button>
            </div>
        </form>
