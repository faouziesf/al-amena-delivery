...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center mb-2 sm:mb-3 sm:mb-3 sm:mb-2 sm:mb-3">
        ...
        <div>
            <h1 class="text-lg sm:text-xl font-bold text-gray-900">Modifier l'Adresse de Collecte</h1>
            <p class="text-gray-600">{{ $pickupAddress->name }}</p>
        </div>
    </div>

    <form action="{{ route('client.pickup-addresses.update', $pickupAddress) }}" method="POST" class="space-y-2 sm:space-y-3 sm:space-y-3 sm:space-y-2 sm:space-y-3">
        @csrf
        @method('PUT')
