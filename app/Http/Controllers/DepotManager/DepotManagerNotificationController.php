...
class DepotManagerNotificationController extends Controller
{
    /**
     * Liste des notifications du chef dépôt
     */
    public function index(Request $request)
    {
        ...
        return view('depot-manager.notifications.index', compact('notifications', 'stats'));
    }
