        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900">Nouveau Ticket de Support</h1>
                        <p class="text-slate-600">Obtenez l'aide dont vous avez besoin</p>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-3">
                <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                    ...
                    <form method="POST" action="{{ route('client.tickets.store') }}" enctype="multipart/form-data" class="p-8 space-y-8" id="ticketForm">
                        @csrf
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <h2 class="text-xl font-bold text-slate-900">Type de demande</h2>
                            </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <label class="ticket-type-option {{ old('type', $complaint ?? false ? 'COMPLAINT' : '') === 'COMPLAINT' ? 'selected' : '' }}" data-value="COMPLAINT">
                                    ...
                                    <div class="text-center p-4 rounded-xl border-2 transition-all duration-200 cursor-pointer hover:border-blue-300 hover:bg-blue-50">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="subject" id="subject" required
                                       ...
                                       class="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('subject') border-red-300 @enderror">
                                @error('subject')
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="6" required
                                          ...
                                          class="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none @error('description') border-red-300 @enderror">{{ old('description', $complaint->description ?? '') }}</textarea>
                                @error('description')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="package_code" id="package_code"
                                           ...
                                           class="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                            ...
                            <div>
                                ...
                                <div class="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-slate-400 transition-colors duration-200" id="dropZone">
                                    ...
                                    <label for="attachments" class="cursor-pointer">
                                        ...
                                        <p class="text-slate-500 mb-4">Glissez-déposez ou cliquez pour sélectionner</p>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                <button type="button" onclick="saveDraft()"
                                        class="inline-flex items-center px-6 py-3 border-2 border-slate-300 text-slate-700 rounded-xl hover:bg-slate-50 font-semibold transition-all duration-200">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button type="submit" id="submitBtn"
                                        class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 sticky top-6">
                        ...
                        <div class="space-y-4 text-sm">
                            ...
                            <div class="flex items-start space-x-3 p-3 bg-orange-50 rounded-xl border border-orange-200">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-6">
                        ...
                        <div class="space-y-3">
                            <a href="mailto:support@alamena.com" class="flex items-center space-x-3 p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors group">
                                <div class="w-8 h-8 bg-slate-200 rounded-lg flex items-center justify-center group-hover:bg-slate-300">
                            ...
                            <a href="tel:+21670123456" class="flex items-center space-x-3 p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors group">
                                <div class="w-8 h-8 bg-slate-200 rounded-lg flex items-center justify-center group-hover:bg-slate-300">
                                    <svg class="w-4 h-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
